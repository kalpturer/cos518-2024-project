...
# Start replica 3
./target/release/project --id 3 -n 5 --listener 127.0.0.1:10000 --connections 127.0.0.1:8000 127.0.0.1:9000 127.0.0.1:10000 127.0.0.1:11000 > replica3.log 2> replica3.err &
# Get its process ID
PID3=$!
# Sleep for 1 second
sleep 1
...
./target/release/project --gen 127.0.0.1:8000 --time-sleep 50 --experiment_time $experiment_len --listener 127.0.0.1:8001 > client1.log 2>&1 &
PID6=$!
./target/release/project --gen 127.0.0.1:9000 --time-sleep 50 --experiment_time $experiment_len --listener 127.0.0.1:9001 > client2.log 2>&1 &
PID7=$!
./target/release/project --gen 127.0.0.1:10000 --time-sleep 50 --experiment_time $experiment_len --listener 127.0.0.1:10001 > client3.log 2>&1 &
PID8=$!
./target/release/project --gen 127.0.0.1:11000 --time-sleep 50 --experiment_time $experiment_len --listener 127.0.0.1:11001 > client4.log 2>&1 &
PID9=$!
./target/release/project --gen 127.0.0.1:12000 --time-sleep 50 --experiment_time $experiment_len --listener 127.0.0.1:12001 > client5.log 2>&1 &
PID10=$!
